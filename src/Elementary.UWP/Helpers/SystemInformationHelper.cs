...
namespace Elementary.Helpers
{
    ...
    public sealed class SystemInformationHelper
    {
        /// <summary>
        ...
        private SystemInformationHelper()
        {
        ...
        public static SystemInformationHelper Instance { get; } = new SystemInformationHelper();
