...
namespace Elementary.WidgetApp
{
    ...
    {
        private const string WidgetId = "Elementary_VerseOfTheDay";
        ...
        private async Task UpdateWidgetAsync(string widgetId)
        {
            try
            {
                ...
                string filename = $"{dateKey}_widget.png";
                ...
                {
                    result = await _votdService.GetAsync(VotdImageSize.Widget640x360);
