...
All screenshots use unmodified captures of the running app, centered on the matching blue hero artwork at 1920×1080. The complete app frame and rounded corners are preserved; the taskbar and desktop clutter are excluded, and the app UI contains no added logos or marketing overlays.
